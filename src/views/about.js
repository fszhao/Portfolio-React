    ...
    <div className="about-container">
      ...
      <div className="about-top-container">
        <nav data-role="Header" className="about-navbar">
          <div className="about-container1">
            <div className="about-right-side">
              <div className="about-links-container">
                ...
                <Link to="/portfolio" className="about-navlink2">
                  Portfolio
                </Link>
                <span className="about-text">Contact</span>
              </div>
              <div className="about-right-side1">
                <a href="#main-section" className="about-link">
                  <SolidButton button="GitHub"></SolidButton>
                </a>
                <a href="#main-section" className="about-link1">
          ...
          <div data-role="MobileMenu" className="about-mobile-menu">
            <div className="about-nav">
              ...
              <div className="about-right-side2">
                <div className="about-links-container1">
                  <span className="about-text01">Home</span>
                  <span className="about-text02">About</span>
                  <span className="about-text03">Tour Packages</span>
                  <span>Contact</span>
                </div>
                <a href="#main-section" className="about-link2">
        ...
        <div className="about-hero">
          <div className="about-content-container">
            <h1 className="Heading about-text06">Frank Zhao</h1>
            <h2 className="Subheading about-subheading">Data Scientist</h2>
      ...
      <div id="main-section" className="about-main">
        <div className="about-features">
          ...
          <div className="about-container2">
            ...
            <FeatureCard2 rootClassName="feature-card2-root-class-name3"></FeatureCard2>
      ...
      <footer className="about-footer">
        <div className="about-container3">
          <span className="about-text11">Copyright © 2022 | Frank Zhao</span>
        </div>
      </footer>
    </div>
  )
